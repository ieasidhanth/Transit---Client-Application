<%@ Page Title="" Language="C#" MasterPageFile="~/master_page.Master" AutoEventWireup="true" CodeBehind="Icontrol_login.aspx.cs" Inherits="IEA_InventoryMgmt.Icontrol_login" %>
                ...
                <div style="padding-top: 30px" class="panel-body">
                    ...
                    <form id="loginform" class="form-horizontal" role="form">
                        ...
                        <div style="margin-bottom: 25px" class="input-group">
                            ...
                            <input id="login-password" type="password" class="form-control" name="password" placeholder="password - same as Windows Password" autocomplete="on">
                        </div>
